<%@ Page Title="View or Delete Assignment Sheet" Language="VB" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="false" CodeFile="view_assign.aspx.vb" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CenterContentPlaceHolder" Runat="Server">
    <div id="content">
    <div id ="assignment_links" style="text-align: center"><a href="create_assign.aspx" title="create_assign">Create Assignment Sheets</a>
        &nbsp;&nbsp; |&nbsp;&nbsp; View or Delete Assignment Sheets <br />
        <br />
        <br />
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="text-align: left; width: 125px" valign="top">
                    &nbsp;</td>
